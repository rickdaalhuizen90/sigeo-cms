 ...
 */
namespace Magento\Sigeo\Model\Attribute\Data;
 ...
 */
class Multiline extends \Magento\Sigeo\Model\Attribute\Data\Text
{
    /**
     ...
     * @return array|string
     */
    public function outputValue($format = \Magento\Sigeo\Model\Attribute\Data\AbstractData::OUTPUT_FORMAT_TEXT)
    {
        ...
        switch ($format) {
            case \Magento\Sigeo\Model\Attribute\Data\AbstractData::OUTPUT_FORMAT_ARRAY:
                $output = $values;
                break;
            case \Magento\Sigeo\Model\Attribute\Data\AbstractData::OUTPUT_FORMAT_HTML:
                $output = implode("<br />", $values);
                break;
            case \Magento\Sigeo\Model\Attribute\Data\AbstractData::OUTPUT_FORMAT_ONELINE:
