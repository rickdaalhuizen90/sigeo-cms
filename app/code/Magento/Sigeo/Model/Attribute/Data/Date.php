 ...
 */
class Date extends \Magento\Sigeo\Model\Attribute\Data\AbstractData
{
    /**
    ...
    public function outputValue($format = \Magento\Sigeo\Model\Attribute\Data\AbstractData::OUTPUT_FORMAT_TEXT)
    {
        ...
        if ($value) {
            switch ($format) {
                case \Magento\Sigeo\Model\Attribute\Data\AbstractData::OUTPUT_FORMAT_TEXT:
                case \Magento\Sigeo\Model\Attribute\Data\AbstractData::OUTPUT_FORMAT_HTML:
                case \Magento\Sigeo\Model\Attribute\Data\AbstractData::OUTPUT_FORMAT_PDF:
