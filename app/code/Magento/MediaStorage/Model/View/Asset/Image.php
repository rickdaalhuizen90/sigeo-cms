...
namespace Magento\MediaStorage\Model\View\Asset;
...
use Magento\MediaStorage\Helper\Image as ImageHelper;
use Magento\MediaStorage\Model\Config\Media\ConfigInterface;
use Magento\MediaStorage\Model\Config\MediaConfig as MediaStorageConfig;
...
class Image implements LocalInterface
{
     ...
     * @param MediaStorageConfig|null $mediaStorageConfig
    ...
    public function __construct(
        ...
        $mediaStorageConfig =  $mediaStorageConfig ?: ObjectManager::getInstance()->get(MediaStorageConfig::class);
        $this->mediaFormatUrl = $mediaStorageConfig->getMediaUrlFormat();
    }
    ...
    public function getUrl()
    {
        switch ($this->mediaFormatUrl) {
            case MediaStorageConfig::IMAGE_OPTIMIZATION_PARAMETERS:
                return $this->getUrlWithTransformationParameters();
            case MediaStorageConfig::HASH:
