...
class Image extends \Magento\Framework\Model\AbstractModel
{
     ...
     */
    protected $_mediaStorageMediaConfig;
     ...
     * @param Config\Media\Config $mediaStorageMediaConfig
    ...
    public function __construct(
        ...
        \Magento\MediaStorage\Model\Config\Media\Config $mediaStorageMediaConfig,
        ...
        $this->_mediaStorageMediaConfig = $mediaStorageMediaConfig;
    ...
    protected function _getWatermarkFilePath()
    {
        ...
        $baseDir = $this->_mediaStorageMediaConfig->getBaseMediaPath();
    ...
    {
        $directory = $this->_mediaStorageMediaConfig->getBaseMediaPath() . '/cache';
        ...
        try {
            ...
            $tmpDirectory = $this->_mediaStorageMediaConfig->getBaseMediaPath() . '/' . $tmpDirBasename;
