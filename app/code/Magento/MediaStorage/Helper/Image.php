 ...
 */
namespace Magento\MediaStorage\Helper;
...
class Image extends AbstractHelper implements ArgumentInterface
{
    ...
    public function __construct(
        ...
        \Magento\MediaStorage\Model\ImageFactory $imageFactory,
        \Magento\Framework\View\Asset\Repository $assetRepo,
        \Magento\Framework\View\ConfigInterface $viewConfig,
        \Magento\MediaStorage\Model\View\Asset\PlaceholderFactory $placeholderFactory = null,
        ...
        $this->viewAssetPlaceholderFactory = $placeholderFactory
            ?: ObjectManager::getInstance()->get(\Magento\MediaStorage\Model\View\Asset\PlaceholderFactory::class);
        $this->mediaConfig = $mediaConfig ?: ObjectManager::getInstance()->get(MediaConfig::class);
    }
    ...
    public function getUrl()
    {
        try {
            switch ($this->mediaConfig->getMediaUrlFormat()) {
                case MediaConfig::IMAGE_OPTIMIZATION_PARAMETERS:
                    $this->initBaseFile();
                    break;
                case MediaConfig::HASH:
